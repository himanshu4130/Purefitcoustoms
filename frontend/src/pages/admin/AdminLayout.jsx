...
import { LogOut, FileText, MessageSquare, Images, LayoutDashboard, Palette, Menu, X, ExternalLink, Layers } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/content", label: "Bottle Manager", icon: Layers, testid: "admin-nav-content" },
